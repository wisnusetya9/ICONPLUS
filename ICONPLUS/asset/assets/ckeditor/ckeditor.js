...
( function() {
	...
	CKEDITOR.tools.extend( CKEDITOR.dom.document.prototype, {
		...
		, getHead: function() {
			...
			return b =
				b ? new CKEDITOR.dom.element( b ) : this.getDocumentElement()
			...
			, enlarge: function( a, b ) {
				switch ( a ) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						if ( p.type == CKEDITOR.NODE_TEXT ) {
							if ( m ) {
								p = !CKEDITOR.tools.trim( p.substring( 0, m ) )
									.length && p;
								k = !!p
							}
						...
						h = k = false;
						if ( p.type == CKEDITOR.NODE_TEXT ) {
							p = !CKEDITOR.tools.trim( p.substring( m ) )
								.length && p;
							k = !( p && p.getLength() );
							if ( p &&
		...
		b.prototype = {
			getNextParagraph: function( b ) {
				...
				if ( !e ) {
					...
					} else if ( !m ) this._.nextNode = e.equals( n ) ? null : c( h.getBoundaryNodes()
						.endNode, 1, n )
				}
				if ( o )( h = e.getPrevious() ) && h.type == CKEDITOR.NODE_ELEMENT && ( h.getName() == "br" ? h.remove() : h.getLast() && h.getLast()
...
, /<noscript[\s\S]*?<\/noscript>/gi ].concat( d ), a = a.replace( /<\!--[\s\S]*?--\>/g, function( a ) {
			...
			a = a.replace( l, function( a, b, d ) {
				return "<\!--" + A + ( b ? "{C}" : "" ) + encodeURIComponent( c[ d ] )
					.replace( /--/g, "%2D%2D" ) + "--\>"
			} );
...
, "tbody" ]
	...
	( function() {
		...
		CKEDITOR.editor.prototype.resize = function( a, b, c, e ) {
			var f = this.container
				...
				, o = CKEDITOR.env.webkit && this.document && this.document.getWindow()
				.$.frameElement
				, e = e ? f.getChild( 1 ) : f;
		...
		var n = function() {
			...
			function f( a, c, d, e ) {
				...
				if ( ( j = ( new CKEDITOR.dom.walker( l ) )
						.next() ) && b( j ) && m[ j.getName() ] && ( g = j.getPrevious() ) && b( g ) && !g.getParent()
			...
			return function( m, s, u ) {
				...
				if ( !D.checkReadOnly() ) {
					...
					if ( u ) {
						...
						if ( ( K = u.startPath()
								.block ) && !( K.getChildCount() == 1 && K.getBogus() ) ) a: {
							var F;
	...
	( function() {
		...
		CKEDITOR.dom.selection.prototype = {
			getNative: function() {
				return this._.cache.nativeSel !== void 0 ? this._.cache.nativeSel : this._.cache.nativeSel = m ? this.document.$.selection : this.document.getWindow()
					.$.getSelection()
			}
			, getType: m ? function() {
				var a = this._.cache;
			...
			, getSelectedText: function() {
				...
				var b = this.getNative()
					, b = m ? b.type == "Control" ? "" : b.createRange()
					.text : b.toString();
	...
	( function() {
		...
		function f( a ) {
			...
			( a = ( new CKEDITOR.dom.elementPath( b, a.root ) )
				.contains( this.element, 1 ) ) && !a.isReadOnly() && z( a, this )
		}
				...
				, select: function( b, a, d ) {
					if ( !( 3 > arguments.length ) ) {
						...
						CKEDITOR.ui.dialog.labeledElement.call( this, b, a, d, function() {
							...
							p( c );
							for ( var j = 0, k; j < a.items.length && ( k = a.items[ j ] ); j++ ) i.push( '<option value="', CKEDITOR.tools.htmlEncode( k[ 1 ] !== void 0 ? k[ 1 ] : k[ 0 ] )
								.replace( /"/g, "&quot;" ), '" /> ', CKEDITOR.tools.htmlEncode( k[ 0 ] ) );
...
, p( A( O, b ), {
	...
	( function() {
		...
		function q( a ) {
			...
			a.editable()
				.hasFocus && ( a.toolbox.focus(), a.focus() )
		}
						...
						, exec: function() {
							...
							"wysiwyg" == a.mode ? j ? ( CKEDITOR.env.gecko && q( a ), a.getSelection()
								.selectRanges( j ), ( i = a.getSelection()
									.getStartElement() ) && i.scrollIntoView( !0 ) ) : d.$.scrollTo( k.x, k.y ) : ( j && ( i.selectionStart = j[ 0 ], i.selectionEnd = j[ 1 ] ), i.scrollLeft =
								k[ 0 ], i.scrollTop = k[ 1 ] );
							j = k = null;
							l = this.state;
	...
	( function() {
		...
		function n( c, d ) {
			...
			for ( h = 0; h < g; h++ ) a[ h ] &&
				( 1 < a[ h ].colSpan && b[ h ] == a[ h ] ? ( e = a[ h ], e.colSpan += 1 ) : ( e = ( new CKEDITOR.dom.element( a[ h ] ) )
