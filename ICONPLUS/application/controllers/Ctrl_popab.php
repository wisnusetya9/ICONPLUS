...
class Ctrl_popab extends CI_Controller
{
	...
	public function popab_Data($page = 1)
    {
        $total = $this->Model_pop->get_total1();
        //ambil data
        $limit  =2; //menentukan limit/jumlah data yang akan ditampilkan per page
        $result = $this->Model_pop->get_all4($limit, $page);
        $url = site_url('Ctrl_popab/popab_Data/');
        $this->load->library('pagination');
        $config['base_url']         = $url;
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/AB/list_popab', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/AB/list_popab', $data);
		}else{
			$this->load->view('user/AB/list_popab', $data);
		}
    }
...
public function search_Data($page, $srch)
    {
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/AB/search_pop', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/AB/search_pop', $data);
		}else{
			$this->load->view('user/AB/search_pop', $data);
		}
    }
	...
	public function read($id_pop) 
	{
		...
		if ($row) {
			...
			$data = array(
				...
				'button' => 'Create',
				'action' => site_url('Ctrl_popab/create_action_room/'.$id_pop),
			...
			if($this->session->userdata('admin')!=''){
				$this->load->view('admin/AB/Detail_popab', $data);
			}else if($this->session->userdata('subadmin')!=''){
				$this->load->view('subadmin/AB/Detail_popab', $data);
			}else{
				$this->load->view('user/AB/Detail_popab', $data);
			}

		} else {
			// $this->session->set_flashdata('message', 'Recofddfrd Not Found');
			if($this->session->userdata('admin')!=''){
			redirect(site_url('admin/AB/list_popab'));
			}else if($this->session->userdata('subadmin')!=''){
			redirect(site_url('subadmin/AB/list_popab'));
			}else{
			redirect(site_url('user/AB/list_popab'));
			}
		}
	}
...
public function back()
	{
		redirect(site_url('Ctrl_popab/popab_Data/'));
	}
public function back_room($id_pop)
	{
		redirect(site_url('Ctrl_popab/read/'.$room->id));
	}
public function back_update_rack()
	{
		redirect(site_url('Ctrl_popab/createRak'));
	}
	...
	public function create() 
{
		$data = array(
			'button' => 'Create',
			'action' => site_url('Ctrl_popab/create_action/'),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/AB/insert_popab', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/AB/insert_popab', $data);
		}else{
			$this->load->view('user/AB/insert_popab', $data);
			}
	}
	...
	public function create_action() 
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (!$this->upload->do_upload('Foto_POP') || !$this->upload->do_upload('Foto_POP2')) {
				...
				redirect(site_url('Ctrl_popab/create/'));
			} else {
				unset($config);
	...
	public function update($id_pop) 
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('Ctrl_popab/update_action/'),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/AB/update_popab', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/AB/update_popab', $data);
		}else{
			$this->load->view('user/AB/update_popab', $data);
			}
	...
	public function update_action($id_pop) 
    {
    	...
    	if ($this->form_validation->run() == FALSE) {
    		...
    		$this->upload->initialize($config);
    			...
    			if (!$this->upload->do_upload('Foto_POP') || !$this->upload->do_upload('Foto_POP2')) {
    				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
    				redirect(site_url('Ctrl_popab/update'));
    			} else {
    				unset($config);
    				$config['upload_path'] = 'public/POP/File';
    				$config['allowed_types'] = '*';
...
public function _rules3() 
	...
	public function createRoom($id_pop) 
	{
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/AB/insert_room', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/AB/insert_room', $data);
		}else{
			$this->load->view('user/AB/insert_room', $data);
			}
		}
	}
	...
	public function create_action_room($id_pop) 
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (!$this->upload->do_upload('Foto_Room') || !$this->upload->do_upload('Foto_Room2')) {
				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
				redirect(site_url('Ctrl_popab/read/'.$id_pop));
			} else {
				unset($config);
	...
	public function update_room($id,$id_pop) 
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('Ctrl_popab/update_room_action/'.$id_pop),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/AB/update_room', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/AB/update_room', $data);
		}else{
			$this->load->view('user/AB/update_room', $data);
			}
			
		} 
		// else {
		// 	$this->session->set_flashdata('message', 'Record Not Fsddound');
		// 	redirect(site_url('Ctrl_popab/read/'));		
		// }
	}
	...
	public function createRak($id) 
	{
		...
		if ($row) {
			...
			$data = array(
				'button' => 'Create',
				'action' => site_url('Ctrl_popab/create_action_rak/'.$id),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/AB/Detail_rack', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/AB/Detail_rack', $data);
		}else{
			$this->load->view('user/AB/Detail_rack', $data);
			}
		}
	}
	...
	public function create_action_rak($id)
	{
		...
		$this->load->library('upload');
			...
			if (!$this->upload->do_upload('Foto_Rak') || !$this->upload->do_upload('Foto_Rak2')) {
				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
				redirect(site_url('Ctrl_popab/createRak/'.$id));
			} else {
				unset($config);
	...
	public function update_rak($id_rak,$id) 
	{
		...
		if ($row) {
			$data = array(
				'button' => 'update',
				'action' => site_url('Ctrl_popab/update_rak_action/'.$id),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/AB/update_rack', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/AB/update_rack', $data);
		}else{
			$this->load->view('user/AB/update_rack', $data);
			}
	...
	public function listperangkat($id) 
	{
		...
		if ($row) {
			...
			$data = array(
				...
				if($this->session->userdata('admin')!=''){
					$this->load->view('admin/AB/list_perangkat', $data);
				}else if($this->session->userdata('subadmin')!=''){
					$this->load->view('subadmin/AB/list_perangkat', $data);
				}else{
					$this->load->view('user/AB/list_perangkat', $data);
					}
		}
	...
	public function createPerangkat($id) 
	{
		...
		if ($row) {
			...
			$data = array(
				'button' => 'Create',
				'action' => site_url('Ctrl_popab/create_action_perangkat/'.$id),
				'kode_room' => set_value('kode_room',$row->kode_room),
				'kode_rak' => set_value('kode_rak',$row->kode_rak),
				'Merk' => set_value('Merk'),
				'Tipe' => set_value('Tipe'),
			...
			if($this->session->userdata('admin')!=''){
				$this->load->view('admin/AB/insert_perangkat', $data);
			}else if($this->session->userdata('subadmin')!=''){
				$this->load->view('subadmin/AB/insert_perangkat', $data);
			}else{
				$this->load->view('user/AB/insert_perangkat', $data);
			}
	...
	public function create_action_perangkat($id)
	{
		...
		$this->load->library('upload');
			...
			if (!$this->upload->do_upload('Foto_perangkat') || !$this->upload->do_upload('Foto_perangkat2')) {
				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
				redirect(site_url('Ctrl_popab/listPerangkat/'.$id));
			} else {
				unset($config);
	...
	public function read_perangkat($id) 
	{
		...
		if ($row) {			
			...
			if($this->session->userdata('admin')!=''){
				$this->load->view('admin/AB/Detail_perangkat', $data);
			}else if($this->session->userdata('subadmin')!=''){
				$this->load->view('subadmin/AB/Detail_perangkat', $data);
			}else{
				$this->load->view('user/AB/Detail_perangkat', $data);
			}
	...
	public function update_perangkat($id_perangkat,$id_rak)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'update',
				'action' => site_url('Ctrl_popab/update_perangkat_action/'.$id_rak),
				'kode_room' => set_value('kode_room',$row ->kode_room),
				'kode_rak' => set_value('kode_rak',$row ->kode_rak),
			...
			if($this->session->userdata('admin')!=''){
				$this->load->view('admin/AB/Update_perangkat', $data);
			}else if($this->session->userdata('subadmin')!=''){
				$this->load->view('subadmin/AB/Update_perangkat', $data);
			}else{
				$this->load->view('user/AB/Update_perangkat', $data);
				}
	...
	{
		$data = array(
		'action' => site_url('Ctrl_popab/login/'),
		);
	...
	public function login(){
		...
		// $this->load->model('Model_Login');
		if ($person == '') {
			redirect('Ctrl_popab/indexlogin', 'refresh');
		}else{
