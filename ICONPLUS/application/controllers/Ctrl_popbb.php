...
class Ctrl_popbb extends CI_Controller
{
	...
	public function popbb_Data($page = 1)
    {
        $total = $this->Model_pop->get_total1();
        //ambil data
        $limit  =2; //menentukan limit/jumlah data yang akan ditampilkan per page
        $result = $this->Model_pop->get_all2($limit, $page);
        $url = site_url('Ctrl_popbb/popbb_Data/');
        $this->load->library('pagination');
        $config['base_url']         = $url;
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/BB/list_popbb', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/BB/list_popbb', $data);
		}else{
			$this->load->view('user/BB/list_popbb', $data);
		}
    }
...
public function search_Data($page, $srch)
    {
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/BB/search_pop', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/BB/search_pop', $data);
		}else{
			$this->load->view('user/BB/search_pop', $data);
		}
    }
	...
	public function read($id_pop) 
	{
		...
		if ($row) {
			...
			$data = array(
				...
				'button' => 'Create',
				'action' => site_url('Ctrl_popbb/create_action_room'.$id_pop),
			...
			if($this->session->userdata('admin')!=''){
				$this->load->view('admin/BB/Detail_popbb', $data);
			}else if($this->session->userdata('subadmin')!=''){
				$this->load->view('subadmin/BB/Detail_popbb', $data);
			}else{
				$this->load->view('user/BB/Detail_popbb', $data);
			}

		} else {
			// $this->session->set_flashdata('message', 'Recofddfrd Not Found');
			if($this->session->userdata('admin')!=''){
			redirect(site_url('admin/BB/Detail_popbb'));
			}else{
			redirect(site_url('user/BB/Detail_popbb'));
			}
		}
	}
...
public function back()
	{
		redirect(site_url('Ctrl_popbb/popbb_Data/'));
	}
public function back_room($id_pop)
	{
		redirect(site_url('Ctrl_popbb/read/'.$room->id));
	}
public function back_update_rack()
	{
		redirect(site_url('Ctrl_popbb/createRak'));
	}
	...
	public function create() 
{
		$data = array(
			'button' => 'Create',
			'action' => site_url('Ctrl_popbb/create_action/'),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/BB/insert_popbb', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/BB/insert_popbb', $data);
		}else{
			$this->load->view('user/insert_popbb', $data);
			}
	}
	...
	public function create_action() 
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (!$this->upload->do_upload('Foto_POP') || !$this->upload->do_upload('Foto_POP2')) {
				...
				redirect(site_url('Ctrl_popbb/create/'));
			} else {
				unset($config);
				...
				if (!$this->upload->do_upload('File_POP')) {
					...
					redirect(site_url('Ctrl_popbb/popbb_Data/1/'));
				} else {
	...
	public function update($id_pop) 
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('Ctrl_popbb/update_action/'),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/BB/update_popbb', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/BB/update_popbb', $data);
		}else{
			$this->load->view('user/BB/update_popbb', $data);
			}
	...
	public function update_action($id_pop) 
    {
    	...
    	if ($this->form_validation->run() == FALSE) {
    		...
    		$this->upload->initialize($config);
    			...
    			if (!$this->upload->do_upload('Foto_POP') || !$this->upload->do_upload('Foto_POP2')) {
    				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
    				redirect(site_url('Ctrl_popbb/update'));
    			} else {
    				unset($config);
    				$config['upload_path'] = 'public/POP/File';
    				$config['allowed_types'] = '*';
	...
	{
		$this->form_validation->set_rules('kode_rak', 'Kode Rak', 'trim|required');
	...
	public function createRoom($id_pop) 
	{
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/BB/insert_room', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/BB/insert_room', $data);
		}else{
			$this->load->view('user/BB/insert_room', $data);
			}
		}
	}
	...
	public function create_action_room($id_pop) 
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (!$this->upload->do_upload('Foto_Room') || !$this->upload->do_upload('Foto_Room2')) {
				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
				redirect(site_url('Ctrl_popbb/read/'.$id_pop));
			} else {
				unset($config);
				...
				if (!$this->upload->do_upload('File_Room')) {
					...
					$this->session->set_flashdata('message', 'Data berhasil di Tambah');
					rredirect(site_url('Ctrl_popbb/read/'.$id_pop));
				}
			}
		}
	}
	...
	public function update_room($id,$id_pop)  
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('Ctrl_popbb/update_room_action/'.$id_pop),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/BB/update_room', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/BB/update_room', $data);
		}else{
			$this->load->view('user/BB/update_room', $data);
			}
	...
	public function update_room_action($id_pop) 
    {
		...
		if ($this->form_validation->run() == FALSE) {
    		...
    		if ($_FILES['Foto_Room']['name'] AND $_FILES['Foto_Room2']['name'] AND $_FILES['File_Room']['name']) {
    		$stringasli = $this->input->post('nama_file',TRUE);
			$stringedit =  str_replace(" ", "_", $stringasli);
			$stringasli2 = $this->input->post('nama_file1',TRUE);
			$stringedit2 =  str_replace(" ", "_", $stringasli2);			
			...
			$this->upload->initialize($config);
    			...
    			if (!$this->upload->do_upload('Foto_Room')) {
    				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
    				redirect(site_url('Ctrl_popbb/read/'.$id_pop));	
    			} else {
						$this->Model_room->update_room($this->input->post('id', TRUE), $data);
    		...
    		if ($_FILES['Foto_Room2']['name']) {
    			...
    			if (!$this->upload->do_upload('Foto_Room2')) {
    				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
    				redirect(site_url('Ctrl_popbb/read/'.$id_pop));	
    			} else {
    					$this->Model_room->update_room($this->input->post('id', TRUE), $data);
	...
	public function createRak($id) 
	{
		...
		if ($row) {
			...
			$data = array(
				'button' => 'Create',
				'action' => site_url('Ctrl_popbb/create_action_rak/'.$id),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/BB/Detail_rack', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/BB/Detail_rack', $data);
		}else{
			$this->load->view('user/BB/Detail_rack', $data);
			}
		}
	}
	...
	public function create_action_rak($id)
	{
		...
		$this->load->library('upload');
			...
			if (!$this->upload->do_upload('Foto_Rak') || !$this->upload->do_upload('Foto_Rak2')) {
				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
				redirect(site_url('Ctrl_popbb/createRak/'.$id));
			} else {
				unset($config);
	...
	public function update_rak($id_rak,$id) 
	{
		...
		if ($row) {
			$data = array(
				'button' => 'update',
				'action' => site_url('Ctrl_popbb/update_rak_action/'.$id),
		...
		if($this->session->userdata('admin')!=''){
			$this->load->view('admin/BB/update_rack', $data);
		}else if($this->session->userdata('subadmin')!=''){
			$this->load->view('subadmin/BB/update_rack', $data);
		}else{
			$this->load->view('user/BB/update_rack', $data);
			}

			
		} else {
			$this->session->set_flashdata('message', 'Record Not Found');
			redirect(site_url('Ctrl_popbb/read'));
	...
	public function update_rak_action($id) 
    {
    	$this->_rules2();
		if ($this->form_validation->run() == FALSE) {
			$this->update_rak($this->input->post('id', TRUE));
    	} else {
    		if ($_FILES['Foto_Rak']['name'] AND $_FILES['Foto_Rak2']['name'] AND $_FILES['File_Rak']['name']) {
    		$stringasli = $this->input->post('nama_file',TRUE);
			$stringedit =  str_replace(" ", "_", $stringasli);
			$stringasli2 = $this->input->post('nama_file1',TRUE);
			$stringedit2 =  str_replace(" ", "_", $stringasli2);			
			...
			$this->upload->initialize($config);
    			...
    			if (!$this->upload->do_upload('Foto_Rak')) {
    				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
    				redirect(site_url('Ctrl_popbb/createRak/'.$id));
    			} else {
						$this->Model_rack->update_rak($this->input->post('id', TRUE), $data);
    		...
    		if ($_FILES['Foto_Rak2']['name']) {
    			...
    			if (!$this->upload->do_upload('Foto_Rak2')) {
    				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
    				redirect(site_url('Ctrl_popbb/createRak/'.$id));
    			} else {
    					$this->Model_rack->update_rak($this->input->post('id', TRUE), $data);
		...
		if ($row) {
			...
			$data = array(
                ...
                'perangkat' => $this->db->query("SELECT * FROM tb_perangkat where kode_rak='$rak' and Tanggal_input in(SELECT MAX(Tanggal_input) as Tanggal_input from tb_perangkat GROUP BY kode_perangkat) ")->result(),
					...
					if($this->session->userdata('admin')!=''){
					$this->load->view('admin/BB/list_perangkat', $data);
				}else if($this->session->userdata('subadmin')!=''){
					$this->load->view('subadmin/BB/list_perangkat', $data);
				}else{
					$this->load->view('user/BB/list_perangkat', $data);
					}
		}
	...
	public function createPerangkat($id) 
	{
		...
		if ($row) {
			...
			$data = array(
				'button' => 'Create',
				'action' => site_url('Ctrl_popbb/create_action_perangkat/'.$id),
				'kode_room' => set_value('kode_room',$row->kode_room),
				'kode_rak' => set_value('kode_rak',$row->kode_rak),
				'Merk' => set_value('Merk'),
				'Tipe' => set_value('Tipe'),
			...
			if($this->session->userdata('admin')!=''){
				$this->load->view('admin/BB/insert_perangkat', $data);
			}else if($this->session->userdata('subadmin')!=''){
				$this->load->view('subadmin/BB/insert_perangkat', $data);
			}else{
				$this->load->view('user/BB/insert_perangkat', $data);
			}
	...
	public function create_action_perangkat($id)
	{
		...
		$this->load->library('upload');
			...
			if (!$this->upload->do_upload('Foto_perangkat') || !$this->upload->do_upload('Foto_perangkat2')) {
				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
				redirect(site_url('Ctrl_popbb/listPerangkat/'.$id));
			} else {
				unset($config);
	...
	public function read_perangkat($id) 
	{
		...
		if ($row) {			
			...
			if($this->session->userdata('admin')!=''){
				$this->load->view('admin/BB/Detail_perangkat', $data);
			}else if($this->session->userdata('subadmin')!=''){
				$this->load->view('subadmin/BB/Detail_perangkat', $data);
			}else{
				$this->load->view('user/BB/Detail_perangkat', $data);
			}
	...
	public function update_perangkat($id_perangkat,$id_rak)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'update',
				'action' => site_url('Ctrl_popbb/update_perangkat_action/'.$id_rak),
				'kode_room' => set_value('kode_room',$row ->kode_room),
				'kode_rak' => set_value('kode_rak',$row ->kode_rak),
			...
			if($this->session->userdata('admin')!=''){
				$this->load->view('admin/BB/Update_perangkat', $data);
			}else if($this->session->userdata('subadmin')!=''){
				$this->load->view('subadmin/BB/Update_perangkat', $data);
			}else{
				$this->load->view('user/BB/Update_perangkat', $data);
				}
	...
	{
			if ($_FILES['Foto_perangkat']['name'] AND $_FILES['Foto_perangkat2']['name'] AND $_FILES['File_perangkat']['name']) {
			$stringasli = $this->input->post('nama_file',TRUE);
			$stringedit =  str_replace(" ", "_", $stringasli);
			$stringasli2 = $this->input->post('nama_file1',TRUE);
			$stringedit2 =  str_replace(" ", "_", $stringasli2);			
		...
		if ($_FILES['Foto_perangkat']['name']) {
    		...
    		if ($_FILES['Foto_perangkat2']['name']) {
	    		$stringasli = $this->input->post('nama_file',TRUE);
	    		$stringedit =  str_replace(" ", "_", $stringasli);
	    		$stringasli2 = $this->input->post('nama_file1',TRUE);
	    		$stringedit2 =  str_replace(" ", "_", $stringasli2);			
	    		...
	    		$this->upload->initialize($config);
	    			...
	    			if (!$this->upload->do_upload('Foto_perangkat2')) {
	    				$this->session->set_flashdata('message', 'Type Data tidak diizinkann harus jpg|png');
	    				redirect(site_url('Ctrl_popbb/listPerangkat/'.$id));
	    			} else {
	    					$this->Model_perangkat->Update($data);
	...
	{
		$data = array(
		'action' => site_url('Ctrl_popbb/login/'),
		);
		$this->load->view('admin/BB/login_view',$data);
	}
	...
	public function login(){
        ...
        $person	  = $this->input->post('person');
		 $this->load->model('Model_Login');
		if ($person == '') {
			redirect('Ctrl_popbb/indexlogin', 'refresh');
		}else{
