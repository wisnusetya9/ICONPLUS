    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active"> POP SB  /  Detail <strong>"POP SB"</strong></li>
            </ol>
        </div><!--/.row-->
...
<div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg> Detail "POP SB <?php echo $Kode_POP; ?>"         </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default" align="center">
                    ...
                    <div class="panel-body" style="width: 800px">
                        ...
                        <div align="right"><a href="<?php echo base_url('index.php/Ctrl_popbb/back')?>" class="btn btn-danger">Kembali</a></div>
                    </div>
                </div>
            </div>
        </div><!--/.row-->  
