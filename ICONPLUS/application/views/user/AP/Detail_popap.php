...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <div class="form-group">
             <form action="<?php echo site_url('Ctrl_popap/search_key/') ?>" class="form-horizontal style-form" method="post" name="search" enctype="multipart/form-data">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active"> POP AP  /  Detail <strong>"POP AP"</strong></li>
            </ol>
        </div><!--/.row-->
...
<div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg> Detail "POP AP <?php echo $Kode_POP; ?>"         </div>
