    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active"> POP BB  /  Detail <strong>"POP BB"</strong></li>
            </ol>
        </div><!--/.row-->
...
<div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <svg class="glyph stroked table"><use xlink:href="#stroked-table"/></svg> Detail "POP BB <?php echo $Kode_POP; ?>"         </div>
