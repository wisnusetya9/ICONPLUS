				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								 <a href="<?php echo base_url(); ?>index.php/Ctrl_popab/popab_Data/1/ab">POP AB</a>
							</li>

							<li class="active">Detail POP AB & List Room
							</li>
...
<div class="row">  
            <div class="col-lg-12">
                <div class="panel panel-default" align="center">
                    ...
                    <a href="<?php echo site_url('Ctrl_popab/createPerangkat/'.$id_rak) ?>" class="btn btn-primary no-border">Tambah Perangkat</a>
                        ...
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name btn-xs" data-sort-order="desc">
                    			...
                    			<td>
                    				...
                    				<a href="<?php echo site_url('Ctrl_popab/read_perangkat/'.$data->id_perangkat)?>">
									...
									<a href="<?php echo site_url('Ctrl_popab/update_perangkat/'.$data->id_perangkat.'/'.$id_rak)?>">
