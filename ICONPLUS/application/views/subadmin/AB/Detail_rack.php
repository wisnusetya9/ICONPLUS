				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Detail Room &nbsp - &nbsp <strong>  "<?php echo $kode_room ?>"</strong>
...
<div id="content">           
            ...
            <div class="col-lg-12">
                <div class="panel panel-default" align="center">
                    <div class="panel-heading">
                    <h2 style="text-underline-position: right;">List Rack  &nbsp - &nbsp  Room <strong> "<?php echo $kode_room?> "</strong></h2></div>                 
                    ...
                    <td>
                    					...
                    					<a href="<?php echo site_url('Ctrl_popab/listperangkat/'.$rak->id_rak)?>">
											<button class="btn btn-success btn-xs no-border " id="open-event" title="Detail">
												<i class="ace-icon glyphicon glyphicon-list"  ></i>
											</button> 
										</a>  

										<a href="<?php echo site_url('Ctrl_popab/update_rak/'.$rak->id_rak.'/'.$id)?>">
 ...
 <a href="javascript:history.back()" class="btn btn-danger no-border">Kembali</a>
			   ...
			   <form action="<?php echo $action; ?>"  class="form-horizontal style-form" method="post" name="power" enctype="multipart/form-data">
                ...
                <label class="col-lg-3 control-label" for="varchar">Kode RAK <?php echo form_error('kode_rak') ?></label>
                	<div class="form-group">
                 		<div class="col-lg-5">
                  			<input type="text" class="form-control" name="kode_rak" id="kode_rak" placeholder="Kode Rack" value="<?php echo $kode_rak; ?>" required/>
                		</div> 
                	</div>
                ...
                <label class="col-lg-3 control-label" for="varchar">Nama RAK <?php echo form_error('nama_rak') ?></label>
                	<div class="form-group">
                  		<div class="col-lg-5">
                  			<input type="text" style="text-transform: capitalize;" class="form-control" name="nama_rak" id="nama_rak" placeholder="Nama Rack" value="<?php echo $nama_rak; ?>" required/>
