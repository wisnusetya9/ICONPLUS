				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo site_url('Ctrl_popab/popab_Data/1/ab') ?>">POP AB</a>
							</li>
		...
		<form action="<?php echo $action; ?>" class="form-horizontal style-form" method="post" name="power" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                         ...
                         <input type="text" readonly="true" class="form-control" name="Area_POP" id="Area_POP" value="Area Barat">
                    ...
                    <label class="col-lg-9"></label>
                      ...
                      <a href="<?php echo site_url('Ctrl_popab/popab_Data/1/ab') ?>" class="btn btn-danger no-border">Cancel</a>
                    </div>
