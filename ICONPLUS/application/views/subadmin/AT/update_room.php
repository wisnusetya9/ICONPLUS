...
<div id="content">           
            ...
            <div class="col-lg-12">
              <div class="form-panel">
                <h4 class="mb"> Update Data Room <?php echo $kode_room; ?></h4>
       ...
       <label class="col-lg-3 control-label" for="int">Kode POP </label>
                    <div class="form-group">
                     ...
                     <label class="col-lg-3 control-label">Kode Room </label>
                    <div class="form-group">
                      <div class="col-lg-5">
                          <input type="text" class="form-control" name="kode_room" id="kode_room" placeholder="Kode Room" value="<?php echo $kode_room; ?>" />
                          <?php echo form_error('kode_room') ?>
                      </div>    
                    </div>

                     <label class="col-lg-3 control-label" >Nama Room </label>
                    <div class="form-group">
                      <div class="col-lg-5">
                          <input type="text" style="text-transform: capitalize;" class="form-control" name="nama_room" id="nama_room" placeholder="Nama Room" value="<?php echo $nama_room; ?>" />
                          <?php echo form_error('nama_room') ?>
                      </div>    
                    </div>
                     ...
                     <label class="col-lg-3 control-label" for="varchar">Foto Room  </label>
                            <div class="form-group">
                              ...
                              <label class="col-lg-3 control-label" for="varchar">Foto Room 2</label>
                            <div class="form-group">
                              <div class="col-lg-5">
