				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo site_url('Ctrl_popat/popat_Data/1/sb') ?>">POP SBU</a>
							</li>
		...
		<form action="<?php echo $action; ?>" class="form-horizontal style-form" method="post" name="power" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-lg-3 control-label" for="int">Tipe POP </label>
                      <div class="form-group">
                        <div class="col-lg-5">
                         <!--  <input type="text" class="form-control" readonly="true" name="Tipe_POP" id="Tipe_POP" value="POP D" /><?php echo form_error('Tipe_POP') ?> -->
                           <select class="form-control"  name="Tipe_POP" id="Tipe_POP" value="Tipe POP">
	                          <option value="">Tipe POP</option>
	                          <option value="POP SB">POP SB</option>
	                          <option value="POP BB">POP BB</option>
                      ...
                      <div class="col-sm-5">
                         ...
                         <input type="text" readonly="true" class="form-control" name="Area_POP" id="Area_POP" value="Area Timur">
                    ...
                    <label class="col-lg-9"></label>
                      ...
                      <a href="<?php echo site_url('Ctrl_popat/popat_Data/1/at') ?>" class="btn btn-danger no-border">Cancel</a>
                    </div>
