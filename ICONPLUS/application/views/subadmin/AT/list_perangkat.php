				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								 <a href="<?php echo base_url(); ?>index.php/Ctrl_popat/popat_Data/1/at">POP AT</a>
							</li>
...
<div class="row">  
            <div class="col-lg-12">
                <div class="panel panel-default" align="center">
                    ...
                    <a href="<?php echo site_url('Ctrl_popat/createPerangkat/'.$id_rak) ?>" class="btn btn-primary no-border">Tambah Perangkat</a>
                        ...
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                    			...
                    			<td>
                    				...
                    				<a href="<?php echo site_url('Ctrl_popat/read_perangkat/'.$data->id_perangkat)?>">
									...
									<a href="<?php echo site_url('Ctrl_popat/update_perangkat/'.$data->id_perangkat.'/'.$id_rak)?>">
 ...
 <div class="col-lg-11" align="right">
         <a href="<?php echo site_url('Ctrl_popat/createRak/') ?>" class="btn btn-danger no-border">Kembali</a>        
  </div>
  </div>
