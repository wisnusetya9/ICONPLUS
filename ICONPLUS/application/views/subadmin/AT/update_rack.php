...
<!--Start page content-->
            <div class="row">
                ...
                <h4 class="mb"><i class="fa fa-angle-right"></i> Update Data Rack Perangkat</h4>
              ...
              <form action="<?php echo $action; ?>"  class="form-horizontal style-form" method="post" name="power" enctype="multipart/form-data">
                ...
                <label class="col-lg-3 control-label">Kode POP <?php echo form_error('kode_pop') ?></label>
                ...
                <label class="col-lg-3 control-label">Kode ROOM <?php echo form_error('kode_room') ?></label>
                  <div class="form-group">
                    <div class="col-lg-5 ">
                ...
                <label class="col-lg-3 control-label">Nama ROOM <?php echo form_error('nama_room') ?></label>
                  <div class="form-group">
                    <div class="col-lg-5 ">
                ...
                <label class="col-lg-3 control-label" >Kode RAK <?php echo form_error('kode_rak') ?></label>
                  <div class="form-group">
                      <div class="col-lg-5 ">
                  ...
                  <label class="col-lg-3 control-label" >Nama RAK <?php echo form_error('nama_rak') ?></label>
                    <div class="form-group">
                      <div class="col-lg-5 ">
                 ...
                 <label class="col-lg-3 control-label" >Foto Rack </label>
                      <div class="form-group">
                        <div class="col-lg-5">
                        ...
                        <label class="col-lg-3 control-label" >Foto Rack 2</label>
                      <div class="form-group">
                        <div class="col-lg-5">
                      ...
                      <label class="col-lg-3 control-label" >File Rack</label>
                    <div class="form-group">
                        <div class="col-lg-5">
                      ...
                      <label class="col-lg-3 control-label" >Tanggal Upload </label>
                      <div class="form-group">
                        ...
                        <label class="col-lg-2 control-label" >Jam Upload </label>
                        <div class="form-group">
                        <div class="col-lg-2 control-label">
                    ...
                    <label class="col-lg-6"></label>
                      <button type="submit" class="btn btn-primary"><?php echo $button ?></button>                  
                          <a href="<?php echo base_url('index.php/Ctrl_popat/createRak/'.$id)?>" class="btn btn-danger">Cancel</a>
                    </div>
                    </form>
                  </div>
                </div></div></div>
