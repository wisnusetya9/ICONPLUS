				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								 <a href="<?php echo base_url(); ?>index.php/Ctrl_popap/popap_Data/1/ap">POP AP</a>
							</li>

							<li class="active">Detail POP AP & List Room
							</li>
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Detail Rack  &nbsp - &nbsp <strong>"<?php echo $kode_rak?>"</strong>
							</h1>
						</div><!-- /.page-header -->
...
<div class="row">  
            <div class="col-lg-12">
                <div class="panel panel-default" align="center">
                    <div class="panel-heading"><h2>List Perangkat &nbsp  -  &nbsp <strong> Rack "<?php echo $kode_rak?>" </strong></h2></div>
                    <div class="panel-body" style="width: 800px">
                    <div class="col-md-12" align="left">
                    <a href="<?php echo site_url('Ctrl_popap/createPerangkat/'.$id_rak) ?>" class="btn btn-primary no-border">Tambah Perangkat</a>

                    </div>
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name btn-xs" data-sort-order="desc">
                                    <thead align="center">
                                        <tr>
                    			...
                    			<td>
                    				...
                    				<a href="<?php echo site_url('Ctrl_popap/read_perangkat/'.$data->id_perangkat)?>">
									...
									<a href="<?php echo site_url('Ctrl_popap/update_perangkat/'.$data->id_perangkat.'/'.$id_rak)?>">
 ...
 <div class="col-lg-11" align="right">
         <a href="<?php echo site_url('Ctrl_popap/createRak/') ?>" class="btn btn-danger no-border">Kembali</a>        
  </div>
  </div>
