        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active">Update Perangkat</li>
            </ul><!-- /.breadcrumb -->
...
<!--Start page content-->
                    ...
                    <div class="row">
                      <div class="col-lg-12 control-label">
                        <div class="page-header">
                          <h1>
                            Update Perangkat - <strong>"<?php echo $kode_perangkat ?>" </strong>                            
                          </h1>
                        </div>
                      </div><!-- /.page-header -->
                    </div>
  <div class="row">
   ...
   <label class="col-lg-3 control-label" for="int">Kode Perangkat</label>
                    <div class="form-group">
                      <div class="col-lg-5">
                             <input type="text" class="form-control" readonly="true" name="kode_perangkat" id="kode_perangkat" placeholder="kode_perangkat" value="<?php echo $kode_perangkat; ?>" required/>
    ...
    <label class="col-lg-3 control-label" for="int">Nama Perangkat</label>
                    <div class="form-group">
                      <div class="col-lg-5">
                            <input type="text" style="text-transform: capitalize;" class="form-control" style="text-transform: capitalize;" name="nama_perangkat" id="nama_perangkat" placeholder="nama_perangkat" value="<?php echo $nama_perangkat; ?>" required/>
          ...
          <label class="col-lg-3 control-label" for="int">Merk</label>
                    <div class="form-group">
                      <div class="col-lg-5">
                            <input type="text" style="text-transform: capitalize;" class="form-control" name="Merk" id="Merk" placeholder="Merk" value="<?php echo $Merk; ?>"  value="<?php echo $Merk; ?>" required/>
            ...
            <label class="col-lg-3 control-label" for="int">Tipe</label>
                    <div class="form-group">
                      <div class="col-lg-5">
                            <input type="text" style="text-transform: capitalize;" class="form-control" name="Tipe" id="Tipe" placeholder="Tipe"  value="<?php echo $Tipe; ?>" required/>
                ...
                <label class="col-lg-3 control-label" for="int">Capasitas</label>
                    <div class="form-group">
                      <div class="col-lg-5">
                            <input type="text" class="form-control" name="Capasitas" id="Capasitas" placeholder="Capasitas" value="<?php echo $Capasitas; ?>" required/>
                    ...
                    <div class="form-group">
                      <div class="col-lg-5">
                            <input type="text" class="form-control" name="Beban_Rectifier" id="Beban_Rectifier" placeholder="Beban Rectifier" value="<?php echo $Beban_Rectifier; ?>" />
                     ...
                     <label class="col-lg-3 control-label" for="varchar">Foto Perangkat </label>
                      <div class="form-group">
                        <div class="col-lg-5">
                          ...
                          <input type="hidden" name="nama_file" value="Foto_perangkat" class="form-control" id="nama_file">
                        </div>    
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-lg-5">
                          <input type="file" class="form-control" name="Foto_perangkat2" onchange="ubah_file3()" id="Foto_perangkat2" placeholder="Foto POP2" /><?php echo form_error('Foto_perangkat2') ?>
                          <input name="nama_file3" value="Foto_perangkat2" class="form-control" id="nama_file3">
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-5">
                          <input type="file" class="form-control" onchange="ubah_file2()" name="File_perangkat" id="File_perangkat" placeholder="File File_perangkat" /> <?php echo form_error('File_perangkat') ?> <!-- <?php echo $File_perangkat; ?> -->
                          <input  name="nama_file1" value="<?php echo $File_perangkat; ?>" class="form-control" id="nama_file1">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-lg-3 control-label">
                         ...
                         <label class="col-lg-3 control-label for="varchar">Keterangan Perangkat <?php echo form_error('keterangan') ?></label>
                        <div class="form-group">
                          <div class="col-lg-6 control-label">
                  <textarea name="keterangan" id="keterangan" placeholder="specifikasi perangkat" class="ckeditor"> <?php echo $keterangan?> </textarea>
                  <script type="text/javascript">
                    ...
                    <div class="form-group">
                      <div class="col-lg-5">
                             ...
                             <button type="submit" class="btn btn-primary no-border"><?php echo $button ?></button> 
                              <a href="javascript:history.back()" class="btn btn-danger no-border">Cancel</a>
                      </div>    
                    </div>   
