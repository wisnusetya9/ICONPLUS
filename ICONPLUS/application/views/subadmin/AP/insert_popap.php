		...
		<form action="<?php echo $action; ?>" class="form-horizontal style-form" method="post" name="power" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                         ...
                         <input type="text" readonly="true" class="form-control" name="Area_POP" id="Area_POP" value="Area Pusat">
                          <?php echo form_error('Area_POP') ?>
                      </div>
                      </div>


                        <label class="col-lg-3 control-label" for="varchar">Foto POP </label>
                      <div class="form-group">
                        <div class="col-lg-5">
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-lg-3 control-label" for="varchar">Keterangan</label>
                      <div class="form-group">
                        <div class="col-lg-5">
                      ...
                      <label class="col-lg-3 control-label" for="varchar">File POP</label>
                    <div class="form-group">
                        <div class="col-lg-5">
                    ...
                    <label class="col-lg-9"></label>
                      ...
                      <a href="<?php echo site_url('Ctrl_popap/popap_Data/1/ap') ?>" class="btn btn-danger no-border">Cancel</a>
                    </div>
