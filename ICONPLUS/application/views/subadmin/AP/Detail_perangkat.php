				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Detail Perangkat &nbsp - &nbsp<strong>"<?php echo $kode_perangkat ?>"</strong>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr class="success">
                                        ...
                                        <tr class="success">
                                            <td> Capasitas</td>
                                            <td><?php echo $Capasitas; ?></td>
                                        </tr>	
                                        <tr class="success">
                                            <td> Beban Rectifier</td>
                                            <td><?php echo $Beban_Rectifier; ?></td>
                                        </tr>	
                                        <tr class="warning">
                                            <td> Foto Rack</td>
                                            <td><?php $gambar = $Foto_perangkat;?>
                                               <a href="#gamb" data-toggle="modal"><img src="<?php echo base_url('public/Perangkat/Foto/'.$gambar);?>" class="img-responsive" width="120px" height="120px"></a>
                                                <?php echo $Foto_perangkat; ?>
                                                </td>
                                        </tr>
                                        <tr class="success">
                                            <td> </td>
                                            <td><?php $gambar2 = $Foto_perangkat2;?>
                                                <a href="#gamb2" data-toggle="modal"><img src="<?php echo base_url('public/Perangkat/Foto/'.$gambar2);?>" class="img-responsive" width="120px" height="120px"></a>
                                                <?php echo $Foto_perangkat2; ?></td>
                                        </tr>

                                        <tr class="warning">
                                            <td> File</td>
                                            <td><a href="<?=base_url()?>public/Perangkat/File/<?=$File_perangkat;?>">
                                                <?php echo $File_perangkat; ?></td>
                                        </tr>	
                                        
                                        <tr class="active">
                                            <td> Spesifikasi Perangkat</td>
                                            <td>
...
<img src="<?php echo base_url('public/Perangkat/Foto/'.$gambar);?>" class="img-responsive" width="100%" height="100%">
                                                <?php echo $Foto_perangkat; ?>
											</div>
										</div><!-- /.modal-content -->
									</div><!-- /.modal-dialog -->
...
<div id="gamb2" class="modal fade" role="dialog" tabindex="-1" >
                      ...
                      <div class="img-responsive">
<img src="<?php echo base_url('public/Perangkat/Foto/'.$gambar2);?>" class="img-responsive" width="100%" height="100%">
                                                <?php echo $Foto_perangkat2; ?>
											</div>
										</div><!-- /.modal-content -->
									</div><!-- /.modal-dialog -->
								</div>	
								    ...
								    <tr>
								       <tr>
								                ...
								                foreach ($perangkat2 as $data) {
								                    ...
								                    <td><?php echo $data->Beban_Rectifier;?></td>
