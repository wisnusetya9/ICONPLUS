					...
					<div class="page-content">
                      ...
                      <div class="col-lg-12 control-label">
                        <div class="page-header">
                          <h1>
                            Insert Perangkat - <strong>"<?php echo $kode_rak ?>" </strong>                            
                          </h1>
                        </div>
                      </div><!-- /.page-header -->
                    </div>
 ...
 <!--  <h4>ROOM <?php echo $kode_room; ?> --- RAK <?php echo $kode_rak; ?></h4> -->
  <div class="row">
   ...
   <label class="col-lg-3 control-label" for="int">Kode Perangkat</label>
                    <div class="form-group">
                      <div class="col-lg-5">
                             <input type="text" class="form-control" name="kode_perangkat" id="kode_perangkat" placeholder="Kode Perangkat" required/>
    ...
    <label class="col-lg-3 control-label" for="int">Nama Perangkat</label>
                    <div class="form-group">
                      <div class="col-lg-5">
                            <input type="text" class="form-control" style="text-transform: capitalize;" name="nama_perangkat" id="nama_perangkat" placeholder="Nama Perangkat" required/>
