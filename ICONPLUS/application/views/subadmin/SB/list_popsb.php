				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('Ctrl_pop/pop_Data/1/sb') ?>">Home</a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<a href="<?php echo base_url('index.php/Ctrl_pop/create/');?>" class="btn btn-info no-border"> Tambah Data</a>
										...
										<div>
											<table class='table table-stripped table-bordered'>
												<thead>
													<tr>
														<th>No </th>
														<th class="hidden-480">Kode POP</th>
														<th >Alamat POP</th>
...
<!-- start content table -->    <?php $no=1; ?>
								...
								<tr>
                                    ...
                                    <td style="text-align:center" width="200px">
										...
										<a href="<?php echo site_url('Ctrl_pop/read/'.$pop_sb->id_pop); ?>">
										...
										<a href="<?php echo site_url('Ctrl_pop/update/'.$pop_sb->id_pop); ?>">
										...
										<!-- <?php echo anchor(site_url('Ctrl_pop/delete/'.$pop_sb->id_pop),'<button class="btn btn-danger btn-sm no-border"  id="show-option" title="Delete">
