				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo site_url('Ctrl_pop/pop_Data/1/sb') ?>">POP SBU</a>
							</li>
							<li class="active">Insert POP</li>
						</ul><!-- /.breadcrumb -->
 ...
 <div style="margin-top: 8px" id="message">
		...
		<form action="<?php echo $action; ?>" class="form-horizontal style-form" method="post" name="power" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      <div class="col-lg-5">
                           <input type="text" class="form-control" name="Kode_POP" id="Kode_POP" placeholder="Kode POP" value="<?php echo $Kode_POP; ?>" /> <?php echo form_error('Kode_POP') ?>
                      </div>    
                    </div>

                        <label class="col-lg-3 control-label" for="varchar"><strong>Alamat POP</strong> </label>
                    <div class="form-group">
                      <div class="col-lg-5">
                          <input type="text" class="form-control" name="Alamat_POP" id="Alamat_POP" placeholder="Alamat POP" value="<?php echo $Alamat_POP; ?>" />
                          <?php echo form_error('Alamat_POP') ?>
                      </div>
                    </div>

                        <label class="col-lg-3 control-label" for="varchar"><strong>Koordinat POP</strong> </label>
                      <div class="form-group">
                        <div class="col-lg-5">
                        ...
                        <label class="col-lg-3 control-label" for="int"><strong>CyberKey</strong> </label>
                      <div class="form-group">
                        <div class="col-lg-5">
                          <input type="text" class="form-control" name="CyberKey" id="CyberKey" placeholder="CyberKey" value="<?php echo $CyberKey; ?>" /><?php echo form_error('CyberKey') ?>
                        </div>  
                      </div>

                        <label class="col-lg-3 control-label" for="int"><strong>Tipe POP</strong> </label>
                      <div class="form-group">
                        <div class="col-lg-5">
                          <input type="text" class="form-control" readonly="true" name="Tipe_POP" id="Tipe_POP" value="POP SB" /><?php echo form_error('Tipe_POP') ?>
                        </div>  
                      </div>

                      <label class="col-lg-3 control-label"><strong>Area POP </strong></label>
                      <div class="form-group">
                      <div class="col-sm-5">
                        <select class="form-control" name="Area_POP" id="Area_POP" value="<?php echo $Area_POP; ?>">
                          <option value="">Area POP</option>
                          <option value="Area Barat">Area Barat</option>
                          <option value="Area Pusat">Area Pusat</option>
                          <option value="Area Timur">Area Timur</option>
                        </select>
                        ...
                        <label class="col-lg-3 control-label" for="varchar"><strong>Foto POP </strong></label>
                      <div class="form-group">
                        <div class="col-lg-5">
                          <input type="file" class="form-control" name="Foto_POP" onchange="ubah_file()" id="Foto_POP" placeholder="Foto POP AP" value="<?php echo $Foto_POP; ?>" /><?php echo form_error('Foto_POP') ?>
                      ...
                      <div class="form-group">
                        <div class="col-lg-5">
                          <input type="file" class="form-control" name="Foto_POP2" onchange="ubah_file3()" id="Foto_POP2" placeholder="Foto POP2" value="<?php echo $Foto_POP2; ?>" /><?php echo form_error('Foto_POP2') ?>
                          <input type="hidden" name="nama_file3" class="form-control" id="nama_file3">
                        </div>
                      </div>

                        <label class="col-lg-3 control-label" for="varchar"><strong>Keterangan</strong></label>
                      <div class="form-group">
                        <div class="col-lg-5">
                          <textarea type="text" class="form-control" style="height: 200px" name="Keterangan" id="Keterangan" placeholder="Keterangan" value="<?php echo $Keterangan; ?>" /></textarea> 
                          <!-- <?php echo form_error('Keterangan') ?> -->
                        </div>
                      </div>

                      <label class="col-lg-3 control-label" for="varchar"><strong>File POP</strong></label>
                    <div class="form-group">
                        <div class="col-lg-5">
                          <input type="file" class="form-control" onchange="ubah_file2()" name="File_POP" id="File_POP" placeholder="File POP" value="<?php echo $File_POP; ?>" /> <?php echo form_error('File_POP') ?>
                          <input type="hidden" name="nama_file1" class="form-control" id="nama_file1">
                        </div>
                      </div>

                      <label class="col-lg-3 control-label" for="int"><strong>Tanggal Upload</strong> </label>
                      <div class="form-group">
                        ...
                        <label class="col-lg-2 control-label" for="int"><strong>Jam Upload</strong> </label>
                        <div class="col-lg-2 control-label">
                    ...
                    <label class="col-lg-9"></label>
                      ...
                      <button type="submit" class="btn btn-primary no-border"><?php echo $button ?></button> 
                      <a href="<?php echo site_url('Ctrl_pop/pop_Data/1/sb') ?>" class="btn btn-danger no-border">Cancel</a>
                    </div>
