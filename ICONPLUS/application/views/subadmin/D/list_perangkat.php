...
<div class="row">  
            <div class="col-lg-12">
                <div class="panel panel-default" align="center">
                    ...
                    <a href="<?php echo site_url('Ctrl_popd/createPerangkat/'.$id_rak) ?>" class="btn btn-primary no-border">Tambah Perangkat</a>
                        ...
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                    			...
                    			<td>
                    				...
                    				<a href="<?php echo site_url('Ctrl_popd/read_perangkat/'.$data->id_perangkat)?>">
									...
									<a href="<?php echo site_url('Ctrl_popd/update_perangkat/'.$data->id_perangkat.'/'.$id_rak)?>">
