				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								 <a href="<?php echo base_url(); ?>index.php/Ctrl_popd/popd_Data/1/d">POP D</a>
							</li>

							<li class="active">Detail POP D & List Room
							</li>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default" align="center">
                    ...
                    <td>
                    					...
                    					<a href="<?php echo site_url('Ctrl_popd/listperangkat/'.$rak->id_rak)?>">
											<button class="btn btn-success btn-xs no-border " id="open-event" title="Detail">
												<i class="ace-icon glyphicon glyphicon-list"  ></i>
											</button> 
										</a>  

										<a href="<?php echo site_url('Ctrl_popd/update_rak/'.$rak->id_rak.'/'.$id)?>">
