				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<!-- <a href="<?php echo base_url('index.php/Ctrl_popbb /create/'.$parm);?>" class="btn btn-info no-border"> Tambah Data</a> -->
						
										<div class="clearfix">
											<div class="pull-right tableTools-container"></div>
										</div>
										<!-- <div class="table-header">
											Results for "<?php echo $tmp; ?>"
										</div> -->
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<center><th class="hidden-480">Action</th></center>
													</tr>
												</thead>
...
<!-- start content table -->    <?php $no=1; ?>
                                    ...
                                    <td style="text-align:center" width="200px">
                                        ...
                                        echo anchor(site_url('Ctrl_popbb/read/'.$pop_bb->id_pop),'Detail'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popbb/update/'.$pop_bb->id_pop),'Update'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popbb/delete/'.$pop_bb->id_pop),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                        ?>
                                    </td>
</tr>
                                <?php 
...
<!-- end content table -->
								...
								<div id="modal-table" class="modal fade" tabindex="-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="warning">
                                         ...
                                         <tr class="warning">
                                            ...
                                            <td><?php $gambar = $Foto_POP;?>
                                                <img src="<?php echo base_url('public/POP/Foto/'.$gambar);?>" class="img-responsive" width="120px" height="120px">
                                                <?php echo $Foto_POP; ?></td>
                                        </tr>
                                        <tr class="warning">
                                            <td> </td>
                                            <td><?php $gambar2 = $Foto_POP2;?>
                                                <img src="<?php echo base_url('public/POP/Foto/'.$gambar2);?>" class="img-responsive" width="120px" height="120px">
                                        ...
                                        <tr class="warning">
                                            <td> File</td>
                                            <td><a href="<?=base_url()?>public/POP_SB/File/<?=$File_POP;?>">
