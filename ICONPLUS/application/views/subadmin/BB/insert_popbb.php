				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo site_url('Ctrl_popbb/popbb_Data/1/sb') ?>">POP BB</a>
							</li>
 ...
 <div style="margin-top: 8px" id="message">
		...
		<form action="<?php echo $action; ?>" class="form-horizontal style-form" method="post" name="power" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-lg-5">
                          <input type="text" class="form-control" readonly="true" name="Tipe_POP" id="Tipe_POP" value="POP BB" /><?php echo form_error('Tipe_POP') ?>
                        </div>  
                      </div>
                    ...
                    <label class="col-lg-9"></label>
                      ...
                      <a href="<?php echo site_url('Ctrl_popbb/popbb_Data/1/bb') ?>" class="btn btn-danger no-border">Cancel</a>
                    </div>
