				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('Ctrl_popbb/popbb_Data/1/bb') ?>">Home</a>
							</li>

							<li>
								<a href="#">POP SBU</a>
							</li>
							<li class="active">POP BB </li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<a href="<?php echo base_url('index.php/Ctrl_popbb/create/');?>" class="btn btn-info no-border"> Tambah Data</a>
...
<!-- start content table -->    <?php $no=1; ?>
                                    <?php if(count($result)):?>
                                    <?php foreach($result as $pop_bb): ?>
								<tr>
                                    <td width="80px"><?php echo $no ?></td>
                                    <td><?php echo $pop_bb->Kode_POP ?></td>
                                    <td><?php echo $pop_bb->Alamat_POP ?></td>
                                    <td><?php echo $pop_bb->Koordinat_POP ?></td>
                                    <td><?php echo $pop_bb->CyberKey ?></td>
                                    
                                    <td style="text-align:center" width="200px">
                                   
										<a href="<?php echo site_url('Ctrl_popbb/read/'.$pop_bb->id_pop); ?>">
										...
										<a href="<?php echo site_url('Ctrl_popbb/update/'.$pop_bb->id_pop); ?>">
										...
										<?php echo anchor(site_url('Ctrl_popbb/delete/'.$pop_bb->id_pop),'<button class="btn btn-danger btn-sm no-border"  id="show-option" title="Delete">
