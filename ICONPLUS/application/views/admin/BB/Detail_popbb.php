				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								 <a href="<?php echo base_url(); ?>index.php/Ctrl_popbb/popbb_Data/1/bb">POP BB</a>
							</li>

							<li class="active">Detail POP BB & List Room
							</li>
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Detail "POP BB - <strong><?php echo $kode_pop ?>" </strong>
...
<br><br>	
                        ...
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                            <font color="red"> <?php echo $this->session->userdata('message') <> '' ? $this->session->userdata('message') : ''; ?></font>
                                    ...
                                    <tbody>
                        				...
                        				<td>
                        	<a href="<?php echo site_url('Ctrl_popbb/createRak/'.$room->id)?>">
										...
										<a href="<?php echo site_url('Ctrl_popbb/update_room/'.$room->id.'/'.$id_pop)?>">
										...
										<?php echo anchor(site_url('Ctrl_popbb/delete_room/'.$room->id.'/'.$id_pop),'<button class="btn btn-danger btn-xs no-border"  id="show-option" title="Delete">
        ...
        <div class="col-md-12" align="right">
         	<a href="<?php echo base_url('index.php/Ctrl_popbb/back/')?>" class="btn btn-danger" data-toggle="modal">
				Kembali 
			</a>
		</div>
