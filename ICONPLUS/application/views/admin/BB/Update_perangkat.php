                     ...
                     <label class="col-lg-3 control-label" for="varchar">Foto Perangkat </label>
                      <div class="form-group">
                        <div class="col-lg-5">
                          ...
                          <input type="text" name="nama_file" value="<?php echo $Foto_perangkat; ?>" class="form-control" id="nama_file">
                        </div>    
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-lg-5">
                          <input type="file" class="form-control" name="Foto_perangkat2" onchange="ubah_file3()" value="<?php echo $Foto_perangkat2; ?>" id="Foto_perangkat2" placeholder="Foto POP2" /><?php echo form_error('Foto_perangkat2') ?>
                          <input name="nama_file3" value="<?php echo $Foto_perangkat2; ?>" class="form-control" id="nama_file3">
                        </div>
                      </div>
