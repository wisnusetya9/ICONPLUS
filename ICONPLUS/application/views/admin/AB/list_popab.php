				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('Ctrl_popab/popab_Data/1/d') ?>">Home</a>
							</li>

							<li>
								<a href="#">POP SBU</a>
							</li>
							<li class="active">POP Area Barat </li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<a href="<?php echo base_url('index.php/Ctrl_popab/create/');?>" class="btn btn-info no-border"> Tambah Data</a>
						
										<div class="clearfix">
											<div class="pull-right tableTools-container"></div>
										</div>
										<div class="table-header">
											Results for POP Area Barat
										</div>
...
<!-- start content table -->    <?php $no=1; ?>
                                    <?php if(count($result)):?>
                                    <?php foreach($result as $popab): ?>
								<tr>
                                    <td width="80px"><?php echo $no ?></td>
                                    <td><?php echo $popab->Kode_POP ?></td>
                                    <td><?php echo $popab->Alamat_POP ?></td>
                                    <td><?php echo $popab->Koordinat_POP ?></td>
                                    <td><?php echo $popab->CyberKey ?></td>
                                    
                                    <td style="text-align:center" width="200px">
                                   
										<a href="<?php echo site_url('Ctrl_popab/read/'.$popab->id_pop); ?>">
										...
										<a href="<?php echo site_url('Ctrl_popab/update/'.$popab->id_pop); ?>">
										...
										<?php echo anchor(site_url('Ctrl_popab/delete/'.$popab->id_pop),'<button class="btn btn-danger btn-sm no-border"  id="show-option" title="Delete">
