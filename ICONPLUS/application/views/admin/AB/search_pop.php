...
<!-- start content table -->    <?php $no=1; ?>
                                    ...
                                    <td style="text-align:center" width="200px">
                                        ...
                                        <?php 
                                        echo anchor(site_url('Ctrl_popab/read/'.$pop_ab->id_pop),'Detail'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popab/update/'.$pop_ab->id_pop),'Update'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popab/delete/'.$pop_ab->id_pop),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                        ?>
                                    </td>
</tr>
                                <?php 
