				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('Ctrl_popd/popd_Data/1/d') ?>">Home</a>
							</li>

							<li>
								<a href="#">POP SBU</a>
							</li>
							<li class="active">POP D </li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<a href="<?php echo base_url('index.php/Ctrl_popd/create/');?>" class="btn btn-info no-border"> Tambah Data</a>
...
<!-- start content table -->    <?php $no=1; ?>
                                    <?php if(count($result)):?>
                                    <?php foreach($result as $pop_d): ?>
								<tr>
                                    <td width="80px"><?php echo $no ?></td>
                                    <td><?php echo $pop_d->Kode_POP ?></td>
                                    <td><?php echo $pop_d->Alamat_POP ?></td>
                                    <td><?php echo $pop_d->Koordinat_POP ?></td>
                                    <td><?php echo $pop_d->CyberKey ?></td>
                                    
                                    <td style="text-align:center" width="200px">
                                   
										<a href="<?php echo site_url('Ctrl_popd/read/'.$pop_d->id_pop); ?>">
										...
										<a href="<?php echo site_url('Ctrl_popd/update/'.$pop_d->id_pop); ?>">
										...
										<?php echo anchor(site_url('Ctrl_popd/delete/'.$pop_d->id_pop),'<button class="btn btn-danger btn-sm no-border"  id="show-option" title="Delete">
												<i class="ace-icon glyphicon glyphicon-trash"></i>
											</button> ','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); ?>
											
                                       <!--  <?php 
                                        echo anchor(site_url('Ctrl_popd/read/'.$pop_d->id_pop),'Detail'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popd/update/'.$pop_d->id_pop),'Update'); 
                                        echo ' | ';
