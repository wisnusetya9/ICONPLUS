				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Detail &nbsp"POP D - <strong><?php echo $kode_pop ?>" </strong>
...
<!--Start page content-->
     ...
     <!--    <?php //echo anchor(site_url('Ctrl_popd/createRoom/'.$id_pop),'Tambah'); ?> -->
...
<br><br>	
                        ...
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                            <font color="red"> <?php echo $this->session->userdata('message') <> '' ? $this->session->userdata('message') : ''; ?></font>
                                    ...
                                    <tbody>
                        				...
                        				<td>
                        	<a href="<?php echo site_url('Ctrl_popd/createRak/'.$room->id)?>">
										...
										<a href="<?php echo site_url('Ctrl_popd/update_room/'.$room->id.'/'.$id_pop)?>">
										...
										<?php echo anchor(site_url('Ctrl_popd/delete_room/'.$room->id.'/'.$id_pop),'<button class="btn btn-danger btn-xs no-border"  id="show-option" title="Delete">
        ...
        <div class="col-md-12" align="right">
         	<a href="<?php echo base_url('index.php/Ctrl_popd/back/')?>" class="btn btn-danger" data-toggle="modal">
				Kembali 
			</a>
		</div>
