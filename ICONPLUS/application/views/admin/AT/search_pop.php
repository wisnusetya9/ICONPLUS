...
<!-- start content table -->    <?php $no=1; ?>
                                    ...
                                    <td style="text-align:center" width="200px">
                                        ...
                                        <?php 
                                        echo anchor(site_url('Ctrl_popat/read/'.$pop_at->id_pop),'Detail'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popat/update/'.$pop_at->id_pop),'Update'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popat/delete/'.$pop_at->id_pop),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                        ?>
                                    </td>
</tr>
                                <?php 
