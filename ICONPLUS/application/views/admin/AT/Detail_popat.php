				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Detail "POP AT - <strong><?php echo $kode_pop ?>" </strong>
...
<br><br>	
                    ...
                    <a href="#modal-table" class="btn btn-info no-border" data-toggle="modal">Tambah Room</a>
                        ...
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                        	...
                        	<a href="<?php echo site_url('Ctrl_popat/createRak/'.$room->id)?>">
										...
										<a href="<?php echo site_url('Ctrl_popat/update_room/'.$room->id.'/'.$id_pop)?>">
										...
										<?php echo anchor(site_url('Ctrl_popat/delete_room/'.$room->id.'/'.$id_pop),'<button class="btn btn-danger btn-xs no-border"  id="show-option" title="Delete">
        ...
        <div class="col-md-12" align="right">
         	<a href="<?php echo base_url('index.php/Ctrl_popat/back/')?>" class="btn btn-danger" data-toggle="modal">
				Kembali 
			</a>
		</div>
