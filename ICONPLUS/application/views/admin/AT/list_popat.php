				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('Ctrl_popat/popat_Data/1/at') ?>">Home</a>
							</li>

							<li>
								<a href="#">POP SBU</a>
							</li>
							<li class="active">POP AT </li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<a href="<?php echo base_url('index.php/Ctrl_popat/create/');?>" class="btn btn-info no-border"> Tambah Data</a>
											...
											<table class='table table-stripped table-bordered'>
												<thead>
													<tr>
														...
														<center><th class="center">Action</th></center>
													</tr>
												</thead>

												<tbody>											
<!-- start content table -->    <?php $no=1; ?>
                                    <?php if(count($result)):?>
                                    <?php foreach($result as $pop_at): ?>
								<tr>
                                    <td width="80px"><?php echo $no ?></td>
                                    <td><?php echo $pop_at->Kode_POP ?></td>
                                    <td><?php echo $pop_at->Alamat_POP ?></td>
                                    <td><?php echo $pop_at->Koordinat_POP ?></td>
                                    <td><?php echo $pop_at->CyberKey ?></td>
                                    
                                    <td style="text-align:center" width="200px">
                                   
										<a href="<?php echo site_url('Ctrl_popat/read/'.$pop_at->id_pop); ?>">
											
										<button class="btn btn-success btn-sm no-border " id="open-event" title="Detail">
												<i class="ace-icon glyphicon glyphicon-list"></i>
											</button> 
										</a>  

										<a href="<?php echo site_url('Ctrl_popat/update/'.$pop_at->id_pop); ?>">
											
										<button class="btn btn-primary btn-sm no-border " id="hide-option" title="Update">
												<i class="ace-icon glyphicon glyphicon-pencil"></i>
											</button>                               

										</a>  
										<?php echo anchor(site_url('Ctrl_popat/delete/'.$pop_at->id_pop),'<button class="btn btn-danger btn-sm no-border"  id="show-option" title="Delete">
												<i class="ace-icon glyphicon glyphicon-trash"></i>
											</button> ','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); ?>
											
                                       <!--  <?php 
                                        echo anchor(site_url('Ctrl_pop/read/'.$pop_sb->id_pop),'Detail'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_pop/update/'.$pop_sb->id_pop),'Update'); 
                                        echo ' | ';
