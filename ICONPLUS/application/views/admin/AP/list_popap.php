				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('Ctrl_popap/popap_Data/1/d') ?>">Home</a>
							</li>

							<li>
								<a href="#">POP SBU</a>
							</li>
							<li class="active">POP Area Pusat </li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<a href="<?php echo base_url('index.php/Ctrl_popap/create/');?>" class="btn btn-info no-border"> Tambah Data</a>
						
										<div class="clearfix">
											<div class="pull-right tableTools-container"></div>
										</div>
										<div class="table-header">
											Results for POP Area Pusat
										</div>
...
<!-- start content table -->    <?php $no=1; ?>
                                    <?php if(count($result)):?>
                                    <?php foreach($result as $popap): ?>
								<tr>
                                    <td width="80px"><?php echo $no ?></td>
                                    <td><?php echo $popap->Kode_POP ?></td>
                                    <td><?php echo $popap->Alamat_POP ?></td>
                                    <td><?php echo $popap->Koordinat_POP ?></td>
                                    <td><?php echo $popap->CyberKey ?></td>
                                    
                                    <td style="text-align:center" width="200px">
                                   
										<a href="<?php echo site_url('Ctrl_popap/read/'.$popap->id_pop); ?>">
										...
										<a href="<?php echo site_url('Ctrl_popap/update/'.$popap->id_pop); ?>">
										...
										<?php echo anchor(site_url('Ctrl_popap/delete/'.$popap->id_pop),'<button class="btn btn-danger btn-sm no-border"  id="show-option" title="Delete">
