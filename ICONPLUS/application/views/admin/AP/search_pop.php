				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<!-- <a href="<?php echo base_url('index.php/Ctrl_pop/create/'.$parm);?>" class="btn btn-info no-border"> Tambah Data</a> -->
...
<!-- start content table -->    <?php $no=1; ?>
                                    ...
                                    <td><?php echo $pop_ap->Kode_POP ?></td>
                                    <td><?php echo $pop_ap->Alamat_POP ?></td>
                                    <td><?php echo $pop_ap->Koordinat_POP ?></td>
                                    <td><?php echo $pop_ap->CyberKey ?></td>
                                    
                                    <td style="text-align:center" width="200px">
                                   
                                 
                                        <?php 
                                        echo anchor(site_url('Ctrl_popap/read/'.$pop_ap->id_pop),'Detail'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popap/update/'.$pop_ap->id_pop),'Update'); 
                                        echo ' | '; 
                                        echo anchor(site_url('Ctrl_popap/delete/'.$pop_ap->id_pop),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                        ?>
                                    </td>
</tr>
                                <?php 
                                        ...
                                        <tr class="warning">
                                         ...
                                         <tr class="warning">
                                            ...
                                            <td><?php $gambar = $Foto_POP;?>
                                                <img src="<?php echo base_url('public/POP_SB/Foto/'.$gambar);?>" class="img-responsive" width="120px" height="120px">
                                                <?php echo $Foto_POP; ?></td>
                                        </tr>
                                        <tr class="warning">
                                            <td> </td>
                                            <td><?php $gambar2 = $Foto_POP2;?>
                                                <img src="<?php echo base_url('public/POP_SB/Foto/'.$gambar2);?>" class="img-responsive" width="120px" height="120px">
