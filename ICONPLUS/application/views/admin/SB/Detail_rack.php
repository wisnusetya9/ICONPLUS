				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Detail Room "<strong><?php echo $kode_room ?>" </strong>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default" align="center">
                    ...
                    <td>
                    					...
                    					<a href="<?php echo site_url('Ctrl_pop/listperangkat/'.$rak->id_rak)?>">
											<button class="btn btn-success btn-xs no-border " id="open-event" title="Detail">
												<i class="ace-icon glyphicon glyphicon-list"  ></i>
											</button> 
										</a>  

										<a href="<?php echo site_url('Ctrl_pop/update_rak/'.$rak->id_rak.'/'.$id)?>">
										<button class="btn btn-primary btn-xs no-border " id="hide-option" title="Update">
												<i class="ace-icon glyphicon glyphicon-pencil"></i>
											</button>                               

										</a>  
										<a href="<?php echo site_url('Ctrl_pop/delete_rak/'.$rak->id_rak.'/'.$id)?>">
